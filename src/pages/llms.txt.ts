...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines = [
    ...
    '',
    '## Reports',
    `- [The Healthspan Gap Index 2026](${base}/reports/healthspan-gap-2026/): Original analysis of WHO data for 185 countries. The average person spends about 9.7 years in poor health at the end of life; the United States has the widest gap in the world at 12.7 years. Full downloadable dataset.`,
    '',
    '## Articles',
