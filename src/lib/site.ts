...
export const UI: Record<UiKey, Record<string, string>> = {
  en: {
    ...
    footerPrivacy: 'Privacy', footerLanguage: 'Language',
  ...
  ms: {
    ...
    footerPrivacy: 'Privasi', footerLanguage: 'Bahasa',
  ...
  'zh-Hans': {
    ...
    footerPrivacy: '隐私', footerLanguage: '语言',
  ...
  'zh-Hant': {
    ...
    footerPrivacy: '隱私', footerLanguage: '語言',
