---
title: "Does NMN Work? NAD+ Boosters and the Evidence"
...
faqs:
  ...
  - q: "Will taking NMN make me live longer?"
    a: "There is no human evidence that it will. The lifespan claims come from mouse studies, and many compounds that worked in mice have failed in people. No completed human trial has shown that NMN extends lifespan or reverses aging. Anyone telling you otherwise is selling ahead of the science."
  - q: "Is NMN safe to take?"
    a: "In short trials, up to about 12 weeks, NMN has been well tolerated with no serious adverse effects reported, mostly in healthy adults. What we do not have is long-term safety data over years, or good data in people with cancer or other illness. Because raising NAD+ has theoretical risks in cancer, this matters. If you have any medical condition or take medication, check with a doctor first."
  - q: "What dose of NMN do studies use?"
    a: "Human trials have used roughly 250 mg to 900 mg per day, sometimes up to 1,200 mg, usually as a single morning dose. There is no established optimal dose, because there is no proven clinical benefit to optimize for. Higher doses raise blood NAD+ more, but that has not been shown to improve health outcomes."
  - q: "Is NMN better than nicotinamide riboside (NR)?"
    a: "Both NMN and NR raise NAD+ in human blood, and no head-to-head trial has shown that either produces better health outcomes, because neither has reliably produced clinical benefits to compare. The choice between them is currently a marketing question, not an evidence-based one. Niacin and plain nicotinamide also raise NAD+ and cost far less."
  - q: "Is there anything with stronger longevity evidence than NMN?"
    a: "Yes, and they are mostly free. Regular exercise, good sleep, not smoking, and a sensible diet have vastly stronger human evidence for living longer and healthier than any NAD+ supplement. If your goal is a longer healthspan, those habits are where the proven returns are. See our guide on why habits beat supplements for longevity."
---
...
2. That decline contributes to aging and age-related disease.
3. Topping NAD+ back up reverses or slows some of that.
...
So the premise that "your NAD+ is crashing with age" is reasonably supported in a few tissues and genuinely uncertain in most. The field needs large, long-term human studies that mostly do not exist yet ([age-related NAD+ decline review, PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC7442590/)). This is preliminary territory dressed up as established fact.
...
- A double-blind trial gave healthy adults 250 mg a day for 12 weeks. Whole-blood NAD+ rose significantly, and the supplement was safe and well tolerated. Importantly, it did not improve any metabolic marker in these healthy people ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC9036060/)).
...
A 2024 systematic review and meta-analysis of randomized controlled trials, covering adults taking 250 to 2,000 mg/day for two weeks to three months, found that NMN raised NAD+ but produced **no significant improvement** in fasting glucose, insulin, HbA1c, insulin resistance, or blood lipids ([meta-analysis, PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC11557618/) / [PubMed](https://pubmed.ncbi.nlm.nih.gov/39531138/)). A separate review reached a blunt conclusion that "an exaggeration of the benefits of NMN supplementation may exist in the field" ([Examine](https://examine.com/supplements/nicotinamide-mononucleotide/)).

The handful of positive signals are modest and fragile:

- A trial in healthy older men (250 mg/day, 12 weeks) found NMN raised NAD+ and produced small, "nominally significant" improvements in gait speed and left-hand grip, with no change in muscle mass or right-hand grip. The authors themselves flag that the result needs larger studies, was limited to healthy older men, and was not corrected for multiple comparisons ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC9158788/)). These are exactly the kinds of small, uncorrected findings that often do not replicate.
- A trial measuring arterial stiffness after long-term NMN found no clear benefit on its main vascular measure ([Scientific Reports](https://www.nature.com/articles/s41598-023-29787-3)).
...
Interestingly, exercise itself boosts the enzymes that recycle NAD+. So the cheapest "NAD+ booster" with real outcome data is a brisk walk and some weights. If you are spending on NMN while skipping the gym and short on sleep, you have the priorities backwards. For more on this, see [why habits beat supplements for longevity](/my/articles/habits-beat-supplements-for-longevity/).

If you do want a supplement with stronger, more boring human evidence, [creatine](/my/articles/creatine-and-longevity/), [omega-3](/my/articles/omega-3-and-longevity/), [vitamin D](/my/articles/vitamin-d-and-longevity/) (if you are low), and [magnesium](/my/articles/magnesium-and-aging/) all have more to stand on than NMN does. Our overview of [whether longevity supplements work](/my/articles/do-longevity-supplements-work/) puts it in context, and the [best longevity supplements](/my/articles/best-longevity-supplements/) guide ranks them by evidence.

## Safety and the long-term unknown

Short-term safety looks reassuring. Across the human trials run so far, mostly up to about 12 weeks and mostly in healthy adults, NMN has been well tolerated, with no serious adverse effects and only mild, transient symptoms ([human-trial safety update, PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10721522/)).
...
In Malaysia, NMN supplements are sold freely online and in health stores, but they are not registered as therapeutic products with the National Pharmaceutical Regulatory Agency (NPRA). That means the burden falls on you to verify quality. Look for products with third-party purity testing certificates (SGS, Intertek, or equivalent). Quality and labelling accuracy vary widely, especially on Shopee and Lazada, where unverified grey-market stock is common.

## Where to buy NMN in Malaysia

NMN is widely available but you need to choose carefully given the quality variation.
